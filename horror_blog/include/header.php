                ...
                <?php else: ?>
                    ...
                    <div class="dropdown mt-2 mt-lg-0 btn-warning rounded-pill">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark">
                            <li class="dropdown-header text-success fw-bold text-bold fs-5 text-decoration-underline">
                                <?php echo htmlspecialchars($userName); ?>
                            </li>
                            <li>
                                <a class="dropdown-item text-white fw-bold" href="profile.php">Profile</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-white fw-bold" href="my_stories.php">My stories</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <?php if (!empty($_SESSION['user_id']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                                    <a class="dropdown-item text-white fw-bold" href="dashboard.php">Admin dashboard</a>
                                <?php endif; ?>
                            </li>
                            <li>
                                <a class="dropdown-item text-danger fw-bold" href="logout.php">Log out</a>
                            </li>
                        </ul>
                    </div>
